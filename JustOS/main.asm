...
;***********************************************************************
;=======================================================================
;=======  Загрузка со 2 сектора винча 80h  =============================
...
;-----------------------------------------------------------------------
	...
	mov	al, 04h     ; число секторов для чтения.
...
; _segment data
    _start_message db "Operation system 0.0.2", 0
...
;--------------------------------------------------------------
db (1024-2-($-0x07C00)) dup(0)  ; align 512*2 bytes
